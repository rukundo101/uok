...
const API_BASE_URL = window.location.hostname === 'localhost' || window.location.hostname === '127.0.0.1'
    ? 'http://localhost:3000/api'  // Development (local)
    // : 'YOUR_RENDER_BACKEND_URL/api'; // Production (we'll update this after deploying backend)
    : 'https://user-management-api-ajiu.onrender.com/api'

// Note: After deploying backend to Render, you'll replace YOUR_RENDER_BACKEND_URL 
// with your actual Render URL (e.g., https://your-app-name.onrender.com)
